...
List<Restaurants> addBakeryData() {
  ...
  bakeryData.add(Restaurants("Live Cake & Bakery Shop", 4, food_ic_popular2, "50 Commentaires"));
  bakeryData.add(Restaurants("Richie Rich Cake Shop", 2, food_ic_item12, "50 Commentaires"));
  bakeryData.add(Restaurants("American Dry Fruit Ice Cream", 5, food_ic_item1, "50 Commentaires"));
  bakeryData.add(Restaurants("Cake & Bakery Shop", 4, food_ic_item13, "50 Commentaires"));
  return bakeryData;
}

List<Restaurants> addDeliveryRestaurantsData() {
  List<Restaurants> deliveryRestaurantsData = List<Restaurants>();
  deliveryRestaurantsData.add(Restaurants("American Chinese cuisine", 4, food_ic_popular4, "50 Commentaires"));
  deliveryRestaurantsData.add(Restaurants("Bread", 2, food_ic_popular3, "50 Commentaires"));
  deliveryRestaurantsData.add(Restaurants("Restro Bistro", 5, food_ic_item1, "50 Commentaires"));
  deliveryRestaurantsData.add(Restaurants("Hugs with mugs", 4, food_ic_item6, "50 Commentaires"));
...
List<Restaurants> addDineOutRestaurantsData() {
  ...
  dineOutRestaurantsData.add(Restaurants("Raise The Bar \nRooftTop", 4, food_ic_item13, "50 Commentaires"));
  dineOutRestaurantsData.add(Restaurants("Destination Restro & Cafe", 2, food_ic_item14, "50 Commentaires"));
  dineOutRestaurantsData.add(Restaurants("Apple Dine", 5, food_ic_item15, "50 Commentaires"));
...
List<Restaurants> addCafeData() {
  ...
  cafeData.add(Restaurants("Domesticated turkey", 4, food_ic_item2, "50 Commentaires"));
  cafeData.add(Restaurants("Germen Chocolate Cake", 2, food_ic_item6, "50 Commentaires"));
  cafeData.add(Restaurants("Tihar", 5, food_ic_item10, "50 Commentaires"));
  cafeData.add(Restaurants("Cafe klatch", 5, food_ic_item1, "50 Commentaires"));
...
List<ViewRestaurants> addViewRestaurantsData() {
  ...
  viewData.add(ViewRestaurants("Boulangerie-Pâtisserie La Guérande", addViewImagesData(), "4", "3 Ilets Village route departementale 7, Les Trois Ilets 97229, Martinique", "","","7 kms", 1, "your first order & application above 199"));
  viewData.add(ViewRestaurants("Germen Chocolate Cake", addViewImagesData(), "4", "50 Commentaires", "\120€ pour 2 personnes", "Sector 19", "7 kms", 1, "your first order & application above 199"));
  viewData.add(ViewRestaurants("Tihar", addViewImagesData(), "4", "50 Commentaires", "\120€ pour 2 personnes", "Sector 19", "7 km", 1, "your first order & application above 199"));
...
List<ReviewModel> addReviewData() {
  ...
  reviewData.add(ReviewModel(food_ic_user1, "super..", "3.0", "20 Aout 2019"));
  reviewData.add(ReviewModel(food_ic_user2, "Très Bon plats ", "3.0", "20 Mai 2019"));
