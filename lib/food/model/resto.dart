...
final String horaire;
  ...
  Resto._({this.name,this.formatted_address, /*this.rating,*/ this.user_ratings_totals, /*this .compound_code,*/ this.place_id, this.photo,  this.type, this.ville, this.horaire, this.lat, this.lng, this.menu, this.siteadmin, this .siteweb, this.verifie, this.numero })
      : id = null,
        reference = null;
